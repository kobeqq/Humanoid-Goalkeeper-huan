...
class G1LOCO13Cfg(LeggedRobotCfg):
    class env(LeggedRobotCfg.env):
        ...
        episode_length_s = 3 # 每个episode长度
        ball_gravity = True # 球重力
        play = False # 是否播放

    class commands: #TODO: 这个类是用于定义目标区域
        
        class ranges_0:
            height = [0.4, 1.2] # 目标区域高度
            width =  [0.2, 1.2] # 目标区域宽度

            maxh = [0.3, 1.5] # 最大高度
            maxw = [0.0, 1.8] # 最大宽度

            evalh = [0.3, 1.5] # 评估高度，公平评估模型能力
            evalw = [0.0, 1.5] # 评估宽度
